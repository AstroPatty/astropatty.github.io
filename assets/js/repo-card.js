// Forked from https://github.com/tarptaeya/repo-card?tab=readme-ov-file, which is in the public domain.
window.tarptaeya = {};
...
window.tarptaeya.reloadRepoCards = async function () {
  ...
  for (const el of document.querySelectorAll(".repo-card")) {
    ...
    <div style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji; border: 1px solid ${
      ...
      theme.background
    }; padding: 16px; font-size: 14px; line-height: 1.5; color: #24292e; height: 150px; display: flex; flex-direction:column;">
